...
{
//     NSLog(@"%.0f\\\%.0f",self.photoContentView.center.x,self.photoContentView.center.y);
//    [UIView animateWithDuration:0.25 animations:^{ // 改变内部cropView的center
//        view.transform =CGAffineTransformMakeScale(1, 1);
//        
////        self.photoContentView.center = CGPointMake(CX_W/2 , self.photoContentView.center.y);
//        
//        
//    }];
...
//    self.photoContentView.center = CGPointMake(CX_W / 2 , 395 / 2 );
    ...
    CGFloat c_x = self.scrollView.center.x;
    CGFloat c_y = self.scrollView.center.y;
